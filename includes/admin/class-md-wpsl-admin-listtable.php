...
class ListTable extends \WP_List_Table
{
    ...
    public static $table_name = 'site_logs';
    ...
    function column_post_id($item)
    {
        $post_link = '-';
        if( $item['post_id'] ){
            $post_link = '<a href="/wp-admin/post.php?post=' . $item['post_id'] . '&action=edit" target="_blank">View Related Post</a>';
        }
